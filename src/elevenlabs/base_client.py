...
from .text_to_sound_effect.client import AsyncTextToSoundEffectClient, TextToSoundEffectClient
...
class BaseElevenLabs:
    ...
    def __init__(
        ...
        *,
        ...
        self.text_to_sound_effect = TextToSoundEffectClient(client_wrapper=self._client_wrapper)
...
class AsyncBaseElevenLabs:
    ...
    def __init__(
        ...
        *,
        ...
        self.text_to_sound_effect = AsyncTextToSoundEffectClient(client_wrapper=self._client_wrapper)
