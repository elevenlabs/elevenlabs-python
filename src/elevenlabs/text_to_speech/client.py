...
class TextToSpeechClient:
    ...
    def convert_as_stream(
        ...
        *,
        ...
        """
        with self._raw_client.convert_as_stream(
            voice_id,
            text=text,
            enable_logging=enable_logging,
            optimize_streaming_latency=optimize_streaming_latency,
...
class AsyncTextToSpeechClient:
    ...
    async def convert(
        ...
        *,
        ...
        async def main() -> None:
            await client.text_to_speech.convert(voice_id='JBFqnCBsd6RMkjVDRZzb', output_format="mp3_44100_128", text='The first move is what sets everything in motion.', model_id='eleven_multilingual_v2', )
        asyncio.run(main())
        """
    ...
    async def convert_with_timestamps(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.text_to_speech.convert_with_timestamps(voice_id='21m00Tcm4TlvDq8ikWAM', text='This is a test for the API of ElevenLabs.', )
        asyncio.run(main())
        """
    ...
    async def convert_as_stream(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.text_to_speech.convert_as_stream(voice_id='JBFqnCBsd6RMkjVDRZzb', output_format="mp3_44100_128", text='The first move is what sets everything in motion.', model_id='eleven_multilingual_v2', )
        asyncio.run(main())
        """
        async with self._raw_client.convert_as_stream(
            voice_id,
            text=text,
            enable_logging=enable_logging,
            optimize_streaming_latency=optimize_streaming_latency,
    ...
    async def stream_with_timestamps(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            response = await client.text_to_speech.stream_with_timestamps(voice_id='JBFqnCBsd6RMkjVDRZzb', output_format="mp3_44100_128", text='The first move is what sets everything in motion.', model_id='eleven_multilingual_v2', )
