...
class RawTextToSpeechClient:
    ...
    def convert_with_timestamps(
        ...
        *,
        ...
        apply_language_text_normalization: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[AudioWithTimestampsResponseModel]:
        """
    ...
    def stream_with_timestamps(
        ...
        *,
        ...
        apply_language_text_normalization: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.Iterator[HttpResponse[typing.Iterator[StreamingAudioChunkWithTimestampsResponseModel]]]:
        """
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            def stream() -> HttpResponse[typing.Iterator[StreamingAudioChunkWithTimestampsResponseModel]]:
                try:
                    if 200 <= _response.status_code < 300:
...
class AsyncRawTextToSpeechClient:
    ...
    async def convert_with_timestamps(
        ...
        *,
        ...
        apply_language_text_normalization: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AudioWithTimestampsResponseModel]:
        """
        Generate speech from text with precise character-level timing information for audio-text synchronization.
    ...
    async def stream_with_timestamps(
        ...
        *,
        ...
        apply_language_text_normalization: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.AsyncIterator[AsyncHttpResponse[typing.AsyncIterator[StreamingAudioChunkWithTimestampsResponseModel]]]:
        """
        Converts text into speech using a voice of your choice and returns a stream of JSONs containing audio as a base64 encoded string together with information on when which character was spoken.
