...
class AsyncTextToSpeechSocketClient(EventEmitterMixin):
    ...
    async def __aiter__(self):
        async for message in self._websocket:
            if isinstance(message, bytes):
                ...
                try:
                    yield construct_type(type_=TextToSpeechSocketClientResponse, object_=json.loads(message))  # type: ignore
                except Exception:
                    _logger.warning(
        ...
        try:
            async for raw_message in self._websocket:
                if isinstance(raw_message, bytes):
                    ...
                    try:
                        parsed = construct_type(type_=TextToSpeechSocketClientResponse, object_=json_data)  # type: ignore
                    except Exception:
                        _logger.warning(
                            "Skipping unknown WebSocket message; update your SDK version to support new message types."
                        )
    ...
    async def recv(self) -> TextToSpeechSocketClientResponse:
        """
        ...
        try:
            return construct_type(type_=TextToSpeechSocketClientResponse, object_=json_data)  # type: ignore
        except Exception:
...
class TextToSpeechSocketClient(EventEmitterMixin):
    ...
    def recv(self) -> TextToSpeechSocketClientResponse:
        """
        Receive a message from the websocket connection.
        """
