...
class RawHistoryClient:
    ...
    ) -> HttpResponse[GetSpeechHistoryResponseModel]:
        """
    ...
    ) -> HttpResponse[SpeechHistoryItemResponseModel]:
        """
...
class AsyncRawHistoryClient:
    ...
    async def get_all(
        ...
        *,
        ...
        source: typing.Optional[HistoryGetAllRequestSource] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetSpeechHistoryResponseModel]:
        """
        Returns a list of your generated audio.
    ...
    async def get(
        self, history_item_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[SpeechHistoryItemResponseModel]:
        """
        Retrieves a history item.
