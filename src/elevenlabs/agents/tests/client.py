...
class TestsClient:
    ...
    def get(self, test_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetTestsResponse:
        """
...
class AsyncTestsClient:
    ...
    async def get(self, test_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetTestsResponse:
        """
        Gets an agent response test by ID.
    ...
    async def update(
        ...
        async def main() -> None:
            await client.agents.tests.update(
                test_id="TeaqRRdTcIfIu2i7BYfT",
                request=UpdateTestsRequestBody_Llm(
                    name="name",
                ),
    ...
    async def delete(self, test_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        ...
        async def main() -> None:
            await client.agents.tests.delete(
                test_id="TeaqRRdTcIfIu2i7BYfT",
            )
