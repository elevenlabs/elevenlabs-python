...
from .types.create_tests_request_body import CreateTestsRequestBody
from .types.get_tests_response import GetTestsResponse
from .types.list_tests_request_sort_mode import ListTestsRequestSortMode
from .types.update_tests_request_body import UpdateTestsRequestBody
from .types.update_tests_response import UpdateTestsResponse
...
class RawTestsClient:
    ...
    def create(
        self, *, request: CreateTestsRequestBody, request_options: typing.Optional[RequestOptions] = None
        ...
        Parameters
        ----------
        request : CreateTestsRequestBody
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=CreateTestsRequestBody, direction="write"
            ),
            headers={
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agent-testing/{encode_path_param(test_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    GetTestsResponse,
                    construct_type(
                        type_=GetTestsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update(
        self, test_id: str, *, request: UpdateTestsRequestBody, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[UpdateTestsResponse]:
        """
        ...
        request : UpdateTestsRequestBody
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="PUT",
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=UpdateTestsRequestBody, direction="write"
            ),
            headers={
                "content-type": "application/json",
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    UpdateTestsResponse,
                    construct_type(
                        type_=UpdateTestsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def list(
        ...
        *,
        ...
        sort_mode: typing.Optional[ListTestsRequestSortMode] = None,
        ...
        sort_mode : typing.Optional[ListTestsRequestSortMode]
...
class AsyncRawTestsClient:
    ...
    async def get(
        self, test_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetTestsResponse]:
        """
        Gets an agent response test by ID.
    ...
    async def update(
        self, test_id: str, *, request: UpdateTestsRequestBody, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[UpdateTestsResponse]:
        """
        Updates an agent response test by ID.
