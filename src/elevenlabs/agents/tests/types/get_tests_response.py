...
class GetTestsResponse_Llm(UncheckedBaseModel):
...
class GetTestsResponse_Tool(UncheckedBaseModel):
...
class GetTestsResponse_Simulation(UncheckedBaseModel):
...
GetTestsResponse = typing_extensions.Annotated[
    typing.Union[GetTestsResponse_Llm, GetTestsResponse_Tool, GetTestsResponse_Simulation],
    UnionMetadata(discriminant="type"),
]
update_forward_refs(GetTestsResponse_Llm)
update_forward_refs(GetTestsResponse_Tool)
update_forward_refs(GetTestsResponse_Simulation)
