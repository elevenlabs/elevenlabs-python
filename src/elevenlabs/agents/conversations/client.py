...
from .types.list_conversations_request_summary_mode import ListConversationsRequestSummaryMode
...
class ConversationsClient:
        ...
        *,
        ...
        exclude_statuses: typing.Optional[
            typing.Union[
                ...
                typing.Sequence[ListConversationsRequestExcludeStatusesItem],
            ]
        ] = None,
        ...
        summary_mode : typing.Optional[ListConversationsRequestSummaryMode]
        ...
        exclude_statuses : typing.Optional[typing.Union[ListConversationsRequestExcludeStatusesItem, typing.Sequence[ListConversationsRequestExcludeStatusesItem]]]
    ...
    def get(
        ...
        conversation_id: str,
        *,
        format: typing.Optional[GetConversationsRequestFormat] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> GetConversationResponseModel:
        """
        ...
        format : typing.Optional[GetConversationsRequestFormat]
...
class AsyncConversationsClient:
    ...
    async def get_signed_url(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.conversations.get_signed_url(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                include_conversation_id=True,
                branch_id="branch_id",
                environment="environment",
    ...
    async def get_webrtc_token(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.conversations.get_webrtc_token(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                participant_name="participant_name",
                branch_id="branch_id",
                environment="environment",
    ...
    async def get(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.conversations.get(
                conversation_id="21m00Tcm4TlvDq8ikWAM",
                format="json",
            )
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.agents.conversations.delete(
                conversation_id="21m00Tcm4TlvDq8ikWAM",
            )
    ...
    async def get_sip_messages(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.conversations.get_sip_messages(
                conversation_id="21m00Tcm4TlvDq8ikWAM",
                page_size=1,
                cursor="cursor",
            )
