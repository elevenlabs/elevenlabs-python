...
class RawConversationsClient:
    ...
    def get(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/conversations/{encode_path_param(conversation_id)}",
            method="GET",
            params={
                "format": format,
            },
    ...
    def get_summary(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/conversations/{encode_path_param(conversation_id)}/summary",
            method="GET",
            params={
    ...
    def get_sip_messages(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/conversations/{encode_path_param(conversation_id)}/sip-messages",
            method="GET",
            params={
                "page_size": page_size,
                "cursor": cursor,
