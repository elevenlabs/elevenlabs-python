...
class RawTagsClient:
    ...
    def assign(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/conversations/{encode_path_param(conversation_id)}/tags",
            method="POST",
            json={
                "tag_ids": tag_ids,
            },
    ...
    def unassign(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/conversations/{encode_path_param(conversation_id)}/tags/{encode_path_param(tag_id)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/tags/{encode_path_param(tag_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
