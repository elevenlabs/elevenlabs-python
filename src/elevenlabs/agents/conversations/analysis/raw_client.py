...
class RawAnalysisClient:
    ...
    def run(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/conversations/{encode_path_param(conversation_id)}/analysis/run",
            method="POST",
    ...
    def run_evaluation(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/conversations/{encode_path_param(conversation_id)}/analysis/evaluations/run",
            method="POST",
            json={
