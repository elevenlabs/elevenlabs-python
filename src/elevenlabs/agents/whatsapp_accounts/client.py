...
class AsyncWhatsappAccountsClient:
    ...
    async def get(
        ...
        async def main() -> None:
            await client.agents.whatsapp_accounts.get(
                phone_number_id="phone_number_id",
            )
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.agents.whatsapp_accounts.delete(
                phone_number_id="phone_number_id",
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.whatsapp_accounts.update(
                phone_number_id="phone_number_id",
            )
    ...
    async def list(
        ...
        async def main() -> None:
            await client.agents.whatsapp_accounts.list(
                agent_id="agent_id",
            )
