...
class RawAgentsClient:
    ...
    def get(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}",
            method="GET",
            params={
    ...
    def duplicate(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/duplicate",
            method="POST",
            json={
                "name": name,
            },
    ...
    def run_tests(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/run-tests",
            method="POST",
            json={
    ...
    def delete_document_rag_index(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/knowledge-base/{encode_path_param(documentation_id)}/rag-index/{encode_path_param(rag_index_id)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
