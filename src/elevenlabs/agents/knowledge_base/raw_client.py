...
from .types.get_or_create_rag_indexes_knowledge_base_response_value import (
...
class RawKnowledgeBaseClient:
    ...
    def size(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agent/{encode_path_param(agent_id)}/knowledge-base/size",
            method="GET",
    ...
    def get_or_create_rag_indexes(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[typing.Dict[str, GetOrCreateRagIndexesKnowledgeBaseResponseValue]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    typing.Dict[str, GetOrCreateRagIndexesKnowledgeBaseResponseValue],
                    construct_type(
                        type_=typing.Dict[str, GetOrCreateRagIndexesKnowledgeBaseResponseValue],  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawKnowledgeBaseClient:
    ...
    async def get_or_create_rag_indexes(
        ...
        *,
        items: typing.Sequence[GetOrCreateRagIndexRequestModel],
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.Dict[str, GetOrCreateRagIndexesKnowledgeBaseResponseValue]]:
        """
        Retrieves and/or creates RAG indexes for multiple knowledge base documents in a single request. Maximum 100 items per request.
