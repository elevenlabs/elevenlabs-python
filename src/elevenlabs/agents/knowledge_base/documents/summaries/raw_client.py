...
from .types.get_summaries_response_value import GetSummariesResponseValue
...
class RawSummariesClient:
        ...
        *,
    ...
    ) -> HttpResponse[typing.Dict[str, GetSummariesResponseValue]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    typing.Dict[str, GetSummariesResponseValue],
                    construct_type(
                        type_=typing.Dict[str, GetSummariesResponseValue],  # type: ignore
...
class AsyncRawSummariesClient:
    ...
    async def get(
        ...
        *,
        document_ids: typing.Optional[typing.Union[str, typing.Sequence[str]]] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.Dict[str, GetSummariesResponseValue]]:
        """
        Gets multiple knowledge base document summaries by their IDs.
