...
class RawDocumentsClient:
    ...
    def get(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/knowledge-base/{encode_path_param(documentation_id)}",
            method="GET",
            params={
                "agent_id": agent_id,
            },
    ...
    def update(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[UpdateDocumentsResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=UpdateDocumentsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_agents(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/knowledge-base/{encode_path_param(documentation_id)}/dependent-agents",
            method="GET",
            params={
    ...
    def get_content(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/knowledge-base/{encode_path_param(documentation_id)}/content",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_source_file_url(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/knowledge-base/{encode_path_param(documentation_id)}/source-file-url",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def move(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/knowledge-base/{encode_path_param(document_id)}/move",
            method="POST",
            json={
                "move_to": move_to,
            },
    ...
    def bulk_delete(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[typing.Dict[str, BulkDeleteDocumentsResponseValue]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=typing.Dict[str, BulkDeleteDocumentsResponseValue],  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawDocumentsClient:
    ...
    async def update(
        ...
        *,
        ...
        content: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[UpdateDocumentsResponse]:
        """
        Update the name and/or content of a document.
    ...
    async def bulk_delete(
        ...
        *,
        ...
        force: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.Dict[str, BulkDeleteDocumentsResponseValue]]:
        """
        Delete multiple documents or folders from the knowledge base. Each id succeeds or fails independently.
