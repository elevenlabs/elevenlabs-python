...
from .types.bulk_delete_documents_response_value import BulkDeleteDocumentsResponseValue
from .types.get_documents_response import GetDocumentsResponse
from .types.update_documents_response import UpdateDocumentsResponse
...
class DocumentsClient:
    ...
    def bulk_delete(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.Dict[str, BulkDeleteDocumentsResponseValue]:
        """
...
class AsyncDocumentsClient:
    ...
    async def create_from_url(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.create_from_url(
                url="url",
            )
    ...
    async def create_from_file(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.create_from_file()
    ...
    async def create_from_text(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.create_from_text(
                text="text",
            )
    ...
    async def create_folder(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.create_folder(
                name="name",
            )
    ...
    async def get(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.get(
                documentation_id="21m00Tcm4TlvDq8ikWAM",
                agent_id="agent_id",
            )
    ...
    async def delete(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.delete(
                documentation_id="21m00Tcm4TlvDq8ikWAM",
                force=True,
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.update(
                documentation_id="21m00Tcm4TlvDq8ikWAM",
            )
    ...
    async def get_agents(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.get_agents(
                documentation_id="21m00Tcm4TlvDq8ikWAM",
                dependent_type="direct",
                page_size=1,
                cursor="cursor",
    ...
    async def get_bulk_agents(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.get_bulk_agents(
                dependent_type="direct",
                page_size=1,
                cursor="cursor",
                document_ids=["21m00Tcm4TlvDq8ikWAM", "31m00Tcm4TlvDq8ikWBM"],
    ...
    async def get_content(
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.get_content(
                documentation_id="documentation_id",
            )
    ...
    async def get_source_file_url(
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.get_source_file_url(
                documentation_id="21m00Tcm4TlvDq8ikWAM",
            )
    ...
    async def move(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.move(
                document_id="21m00Tcm4TlvDq8ikWAM",
            )
    ...
    async def bulk_move(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.bulk_move(
                document_ids=["21m00Tcm4TlvDq8ikWAM", "31m00Tcm4TlvDq8ikWBM"],
            )
    ...
    async def bulk_delete(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.documents.bulk_delete(
                document_ids=["21m00Tcm4TlvDq8ikWAM", "31m00Tcm4TlvDq8ikWBM"],
            )
