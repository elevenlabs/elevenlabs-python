...
class GetDocumentsResponse_Url(UncheckedBaseModel):
...
class GetDocumentsResponse_File(UncheckedBaseModel):
...
class GetDocumentsResponse_Text(UncheckedBaseModel):
...
class GetDocumentsResponse_Folder(UncheckedBaseModel):
...
GetDocumentsResponse = typing_extensions.Annotated[
    typing.Union[
        GetDocumentsResponse_Url, GetDocumentsResponse_File, GetDocumentsResponse_Text, GetDocumentsResponse_Folder
    ],
