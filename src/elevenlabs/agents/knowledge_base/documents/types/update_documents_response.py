...
class UpdateDocumentsResponse_Url(UncheckedBaseModel):
...
class UpdateDocumentsResponse_File(UncheckedBaseModel):
...
class UpdateDocumentsResponse_Text(UncheckedBaseModel):
...
class UpdateDocumentsResponse_Folder(UncheckedBaseModel):
...
UpdateDocumentsResponse = typing_extensions.Annotated[
    typing.Union[
