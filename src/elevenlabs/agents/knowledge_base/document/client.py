...
class AsyncDocumentClient:
    ...
    async def update_file(
        ...
        async def main() -> None:
            await client.agents.knowledge_base.document.update_file(
                documentation_id="21m00Tcm4TlvDq8ikWAM",
            )
    ...
    async def refresh(
        ...
        async def main() -> None:
            await client.agents.knowledge_base.document.refresh(
                documentation_id="21m00Tcm4TlvDq8ikWAM",
            )
    ...
    async def compute_rag_index(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.knowledge_base.document.compute_rag_index(
                documentation_id="21m00Tcm4TlvDq8ikWAM",
                model="e5_mistral_7b_instruct",
            )
