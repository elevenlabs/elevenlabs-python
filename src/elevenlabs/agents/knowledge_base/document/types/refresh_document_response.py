...
class RefreshDocumentResponse_Url(UncheckedBaseModel):
...
class RefreshDocumentResponse_File(UncheckedBaseModel):
...
class RefreshDocumentResponse_Text(UncheckedBaseModel):
...
class RefreshDocumentResponse_Folder(UncheckedBaseModel):
...
RefreshDocumentResponse = typing_extensions.Annotated[
    typing.Union[
