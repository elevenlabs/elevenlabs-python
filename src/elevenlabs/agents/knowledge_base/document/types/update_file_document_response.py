...
class UpdateFileDocumentResponse_Url(UncheckedBaseModel):
...
class UpdateFileDocumentResponse_File(UncheckedBaseModel):
...
class UpdateFileDocumentResponse_Text(UncheckedBaseModel):
...
class UpdateFileDocumentResponse_Folder(UncheckedBaseModel):
...
UpdateFileDocumentResponse = typing_extensions.Annotated[
    typing.Union[
