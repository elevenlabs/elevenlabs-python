...
class ListPhoneNumbersResponseItem_Twilio(UncheckedBaseModel):
...
class ListPhoneNumbersResponseItem_Exotel(UncheckedBaseModel):
...
class ListPhoneNumbersResponseItem_SipTrunk(UncheckedBaseModel):
...
ListPhoneNumbersResponseItem = typing_extensions.Annotated[
    typing.Union[
        ListPhoneNumbersResponseItem_Twilio, ListPhoneNumbersResponseItem_Exotel, ListPhoneNumbersResponseItem_SipTrunk
    ],
