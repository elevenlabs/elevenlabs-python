...
class UpdatePhoneNumbersResponse_Exotel(UncheckedBaseModel):
...
class UpdatePhoneNumbersResponse_SipTrunk(UncheckedBaseModel):
...
UpdatePhoneNumbersResponse = typing_extensions.Annotated[
    typing.Union[
        UpdatePhoneNumbersResponse_Twilio, UpdatePhoneNumbersResponse_Exotel, UpdatePhoneNumbersResponse_SipTrunk
    ],
