...
class GetPhoneNumbersResponse_Twilio(UncheckedBaseModel):
...
class GetPhoneNumbersResponse_Exotel(UncheckedBaseModel):
...
class GetPhoneNumbersResponse_SipTrunk(UncheckedBaseModel):
...
GetPhoneNumbersResponse = typing_extensions.Annotated[
    typing.Union[GetPhoneNumbersResponse_Twilio, GetPhoneNumbersResponse_Exotel, GetPhoneNumbersResponse_SipTrunk],
