...
from .types.create_phone_numbers_request_body import CreatePhoneNumbersRequestBody
...
class PhoneNumbersClient:
    ...
    def create(
        self, *, request: CreatePhoneNumbersRequestBody, request_options: typing.Optional[RequestOptions] = None
        ...
        Parameters
        ----------
        request : CreatePhoneNumbersRequestBody
...
class AsyncPhoneNumbersClient:
    ...
    async def create(
        ...
        async def main() -> None:
            await client.agents.phone_numbers.create(
                request=CreatePhoneNumbersRequestBody_Twilio(
                    phone_number="phone_number",
                    label="label",
                    sid="sid",
    ...
    async def get(
        ...
        async def main() -> None:
            await client.agents.phone_numbers.get(
                phone_number_id="TeaqRRdTcIfIu2i7BYfT",
            )
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.agents.phone_numbers.delete(
                phone_number_id="TeaqRRdTcIfIu2i7BYfT",
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.phone_numbers.update(
                phone_number_id="TeaqRRdTcIfIu2i7BYfT",
            )
    ...
    async def get_sip_messages(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.phone_numbers.get_sip_messages(
                phone_number_id="TeaqRRdTcIfIu2i7BYfT",
                page_size=1,
                cursor="cursor",
            )
