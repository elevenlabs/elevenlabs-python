...
class RawPhoneNumbersClient:
    ...
    def create(
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=CreatePhoneNumbersRequestBody, direction="write"
            ),
            headers={
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/phone-numbers/{encode_path_param(phone_number_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_sip_messages(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/phone-numbers/{encode_path_param(phone_number_id)}/sip-messages",
            method="GET",
            params={
                "page_size": page_size,
                "cursor": cursor,
