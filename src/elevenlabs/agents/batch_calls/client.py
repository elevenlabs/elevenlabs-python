...
class AsyncBatchCallsClient:
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.batch_calls.create(
                call_name="call_name",
                agent_id="agent_id",
                recipients=[OutboundCallRecipient()],
            )
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.batch_calls.list(
                limit=1,
                last_doc="last_doc",
                agent_id="agent_id",
            )
    ...
    async def get(
        ...
        async def main() -> None:
            await client.agents.batch_calls.get(
                batch_id="batch_id",
            )
    ...
    async def delete(self, batch_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.agents.batch_calls.delete(
                batch_id="batch_id",
            )
    ...
    async def cancel(
        ...
        async def main() -> None:
            await client.agents.batch_calls.cancel(
                batch_id="batch_id",
            )
    ...
    async def retry(
        ...
        async def main() -> None:
            await client.agents.batch_calls.retry(
                batch_id="batch_id",
            )
    ...
    async def export(
        ...
        async def main() -> None:
            await client.agents.batch_calls.export(
                batch_id="batch_id",
            )
