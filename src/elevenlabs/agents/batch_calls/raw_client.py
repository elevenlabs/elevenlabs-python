...
class RawBatchCallsClient:
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/batch-calling/{encode_path_param(batch_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def cancel(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/batch-calling/{encode_path_param(batch_id)}/cancel",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def retry(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/batch-calling/{encode_path_param(batch_id)}/retry",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def export(
        ...
        with self._client_wrapper.httpx_client.stream(
            f"v1/convai/batch-calling/{encode_path_param(batch_id)}/export",
            method="GET",
            request_options=request_options,
        ) as _response:
