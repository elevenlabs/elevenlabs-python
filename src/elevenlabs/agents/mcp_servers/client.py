...
class AsyncMcpServersClient:
    ...
    async def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> McpServersResponseModel:
        ...
        async def main() -> None:
            await client.agents.mcp_servers.list()
    ...
    async def create(
        ...
        async def main() -> None:
            await client.agents.mcp_servers.create(
                config=McpServerConfigInput(
                    url="url",
                    name="name",
                ),
    ...
    async def get(
        ...
        async def main() -> None:
            await client.agents.mcp_servers.get(
                mcp_server_id="mcp_server_id",
            )
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.agents.mcp_servers.delete(
                mcp_server_id="mcp_server_id",
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.mcp_servers.update(
                mcp_server_id="mcp_server_id",
            )
