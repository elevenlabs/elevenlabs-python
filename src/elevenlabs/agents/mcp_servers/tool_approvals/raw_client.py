...
class RawToolApprovalsClient:
    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/mcp-servers/{encode_path_param(mcp_server_id)}/tool-approvals",
            method="POST",
            json={
                "tool_name": tool_name,
    ...
    def delete(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/mcp-servers/{encode_path_param(mcp_server_id)}/tool-approvals/{encode_path_param(tool_name)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
