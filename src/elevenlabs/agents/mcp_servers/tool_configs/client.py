...
class AsyncToolConfigsClient:
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.mcp_servers.tool_configs.create(
                mcp_server_id="mcp_server_id",
                environment="environment",
                tool_name="tool_name",
            )
    ...
    async def get(
        ...
        async def main() -> None:
            await client.agents.mcp_servers.tool_configs.get(
                mcp_server_id="mcp_server_id",
                tool_name="tool_name",
            )
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.agents.mcp_servers.tool_configs.delete(
                mcp_server_id="mcp_server_id",
                tool_name="tool_name",
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.mcp_servers.tool_configs.update(
                mcp_server_id="mcp_server_id",
                tool_name="tool_name",
                environment="environment",
            )
