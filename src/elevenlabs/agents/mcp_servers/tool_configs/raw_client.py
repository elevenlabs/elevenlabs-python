...
class RawToolConfigsClient:
    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/mcp-servers/{encode_path_param(mcp_server_id)}/tool-configs",
            method="POST",
            params={
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/mcp-servers/{encode_path_param(mcp_server_id)}/tool-configs/{encode_path_param(tool_name)}",
            method="GET",
            request_options=request_options,
        )
        try:
