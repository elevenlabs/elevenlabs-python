...
if typing.TYPE_CHECKING:
    ...
    from . import tool_approvals, tool_configs, tools
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "McpToolConfigOverrideCreateRequestModelInputOverridesValue_Omit": ".tool_configs",
    "McpToolConfigOverrideCreateRequestModelToolCallSound": ".tool_configs",
    ...
    "McpToolConfigOverrideUpdateRequestModelInputOverridesValue_Omit": ".tool_configs",
    "McpToolConfigOverrideUpdateRequestModelToolCallSound": ".tool_configs",
