...
class RawTriageTicketsClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/triage-tickets",
            method="GET",
            params={
                "page_size": page_size,
    ...
    def list_assignable_users(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/triage-tickets/assignable-users",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/triage-tickets/{encode_path_param(agentqa_ticket_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def add_comment(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/triage-tickets/{encode_path_param(agentqa_ticket_id)}/comments",
            method="POST",
            json={
                "comment": comment,
            },
    ...
    def add_turn_comment(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/triage-tickets/{encode_path_param(agentqa_ticket_id)}/turn-comments",
            method="POST",
            json={
