...
class RawBranchesClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/branches",
            method="GET",
            params={
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/branches/{encode_path_param(branch_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def preview_merge(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/branches/{encode_path_param(source_branch_id)}/merge-preview",
            method="GET",
            params={
    ...
    def merge(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/branches/{encode_path_param(source_branch_id)}/merge",
            method="POST",
            params={
                "target_branch_id": target_branch_id,
            },
    ...
    def preview_rebase(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/branches/{encode_path_param(branch_id)}/rebase-preview",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def rebase(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{encode_path_param(agent_id)}/branches/{encode_path_param(branch_id)}/rebase",
            method="POST",
            request_options=request_options,
        )
        try:
