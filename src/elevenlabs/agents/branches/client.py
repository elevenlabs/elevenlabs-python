...
class AsyncBranchesClient:
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.branches.create(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                parent_version_id="parent_version_id",
                name="name",
                description="description",
    ...
    async def get(
        ...
        async def main() -> None:
            await client.agents.branches.get(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                branch_id="agtbranch_0901k4aafjxxfxt93gd841r7tv5t",
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.branches.update(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                branch_id="agtbranch_0901k4aafjxxfxt93gd841r7tv5t",
            )
    ...
    async def preview_merge(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.branches.preview_merge(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                source_branch_id="agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
                target_branch_id="agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
                force=True,
    ...
    async def merge(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.branches.merge(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                source_branch_id="agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
                target_branch_id="agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
            )
    ...
    async def preview_rebase(
        ...
        async def main() -> None:
            await client.agents.branches.preview_rebase(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                branch_id="agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
            )
    ...
    async def rebase(
        ...
        async def main() -> None:
            await client.agents.branches.rebase(
                agent_id="agent_3701k3ttaq12ewp8b7qv5rfyszkz",
                branch_id="agtbrch_8901k4t9z5defmb8vh3e9361y7nj",
            )
