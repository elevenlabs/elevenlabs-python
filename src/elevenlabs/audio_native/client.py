...
class AsyncAudioNativeClient:
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.audio_native.create(name='name', )
        asyncio.run(main())
        """
    ...
    async def get_settings(
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.audio_native.get_settings(project_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def update_content(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.audio_native.update_content(project_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
