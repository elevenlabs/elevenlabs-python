...
class SamplesClient:
    ...
    def get_audio(
        ...
        typing.Iterator[bytes]
            Successful Response
        """
        with self._raw_client.get_audio(voice_id, sample_id, request_options=request_options) as r:
            yield from r.data
...
class AsyncSamplesClient:
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.samples.delete(voice_id='21m00Tcm4TlvDq8ikWAM', sample_id='VW7YKqPnjY4h39yTbx2L', )
        asyncio.run(main())
        """
    ...
    async def get_audio(
        ...
        typing.AsyncIterator[bytes]
            Successful Response
        """
        async with self._raw_client.get_audio(voice_id, sample_id, request_options=request_options) as r:
