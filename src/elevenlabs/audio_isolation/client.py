    ...
    def audio_isolation(
        ...
        *,
        ...
        typing.Iterator[bytes]
            Successful Response
        """
        with self._raw_client.audio_isolation(
            audio=audio, file_format=file_format, request_options=request_options
        ) as r:
            yield from r.data
    ...
    def audio_isolation_stream(
        ...
        *,
        ...
        typing.Iterator[bytes]
            Successful Response
        """
        with self._raw_client.audio_isolation_stream(
            audio=audio, file_format=file_format, request_options=request_options
        ) as r:
            yield from r.data
    ...
    async def audio_isolation(
        ...
        *,
        ...
        typing.AsyncIterator[bytes]
            Successful Response
        """
        async with self._raw_client.audio_isolation(
            audio=audio, file_format=file_format, request_options=request_options
        ) as r:
    ...
    async def audio_isolation_stream(
        ...
        *,
        ...
        typing.AsyncIterator[bytes]
            Successful Response
        """
        async with self._raw_client.audio_isolation_stream(
            audio=audio, file_format=file_format, request_options=request_options
        ) as r:
            async for data in r.data:
                yield data
