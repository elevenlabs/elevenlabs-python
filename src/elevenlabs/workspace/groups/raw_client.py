...
class RawGroupsClient:
    ...
    ) -> HttpResponse[typing.Dict[str, WorkspaceGroupResponseModel]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=typing.Dict[str, WorkspaceGroupResponseModel],  # type: ignore
...
class AsyncRawGroupsClient:
    ...
    async def list(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.Dict[str, WorkspaceGroupResponseModel]]:
        """
        Get all groups in the workspace
