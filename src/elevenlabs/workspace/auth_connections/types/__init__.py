...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AuthConnectionsCreateResponse_RefreshTokenAuth": ".auth_connections_create_response",
    ...
    "AuthConnectionsUpdateResponse_RefreshTokenAuth": ".auth_connections_update_response",
