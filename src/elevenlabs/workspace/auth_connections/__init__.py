...
if typing.TYPE_CHECKING:
    from .types import (
        ...
        AuthConnectionsUpdateResponse_RefreshTokenAuth,
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AuthConnectionsCreateResponse_RefreshTokenAuth": ".types",
    ...
    "AuthConnectionsUpdateRequestBody_BearerAuth": ".types",
    ...
    "AuthConnectionsUpdateResponse_RefreshTokenAuth": ".types",
