...
class AgentConfigApiModel(UncheckedBaseModel):
...
update_forward_refs(ArrayJsonSchemaProperty, AgentConfigApiModel=AgentConfigApiModel)
update_forward_refs(ObjectJsonSchemaProperty, AgentConfigApiModel=AgentConfigApiModel)
