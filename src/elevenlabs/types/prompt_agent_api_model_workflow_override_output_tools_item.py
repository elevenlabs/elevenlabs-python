...
class PromptAgentApiModelWorkflowOverrideOutputToolsItem_Client(UncheckedBaseModel):
    """
    The type of tool
    """
...
class PromptAgentApiModelWorkflowOverrideOutputToolsItem_Webhook(UncheckedBaseModel):
    """
    The type of tool
    """
...
# update_forward_refs(PromptAgentApiModelWorkflowOverrideOutputToolsItem_Client)  # Moved to _update_forward_refs_once()
# update_forward_refs(PromptAgentApiModelWorkflowOverrideOutputToolsItem_Webhook)  # Moved to _update_forward_refs_once()
