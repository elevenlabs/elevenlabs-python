...
class AgentConfigApiModelWorkflowOverrideOutput(UncheckedBaseModel):
...
# update_forward_refs(AgentConfigApiModelWorkflowOverrideOutput)  # Moved to _update_forward_refs_once()
...
def _update_forward_refs_once():
    ...
    if not _forward_refs_updated:
        ...
        update_forward_refs(AgentConfigApiModelWorkflowOverrideOutput)
