...
# update_forward_refs(ToolResponseModelToolConfig_Client)  # Moved to _update_forward_refs_once()
# update_forward_refs(ToolResponseModelToolConfig_Webhook)  # Moved to _update_forward_refs_once()
