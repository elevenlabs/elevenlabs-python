...
class VoiceResponseModel(UncheckedBaseModel):
    ...
    samples: typing.Optional[typing.List[SampleResponseModel]] = pydantic.Field(default=None)
    """
    List of samples associated with the voice.
    """

    category: VoiceResponseModelCategory = pydantic.Field()
    """
    The category of the voice.
    """

    fine_tuning: typing.Optional[FineTuningResponseModel] = pydantic.Field(default=None)
    """
    ...
    available_for_tiers: typing.List[str] = pydantic.Field()
    """
    The tiers the voice is available for.
    """

    settings: typing.Optional[VoiceSettingsResponseModel] = pydantic.Field(default=None)
    """
    The settings of the voice.
    """

    sharing: typing.Optional[VoiceSharingResponseModel] = pydantic.Field(default=None)
    """
    The sharing information of the voice.
    """

    high_quality_base_model_ids: typing.List[str] = pydantic.Field()
    """
    ...
    voice_verification: typing.Optional[VoiceVerificationResponseModel] = pydantic.Field(default=None)
    """
