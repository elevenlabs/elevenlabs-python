...
class GptImage25SunburstRequest(UncheckedBaseModel):
    """
    ...
    quality: typing.Optional[GptImage25SunburstRequestQuality] = pydantic.Field(default=None)
    """
    The quality of the output image.
    """

    aspect_ratio: typing.Optional[GptImage25SunburstRequestAspectRatio] = pydantic.Field(default=None)
    """
    The aspect ratio of the output image. With `auto`, the model picks an aspect ratio based on the inputs.
    """

    resolution: typing.Optional[GptImage25SunburstRequestResolution] = pydantic.Field(default=None)
    """
