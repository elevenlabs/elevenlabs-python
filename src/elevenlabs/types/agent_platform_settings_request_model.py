...
class AgentPlatformSettingsRequestModel(UncheckedBaseModel):
    evaluation: typing.Optional[EvaluationSettingsInput] = pydantic.Field(default=None)
    """
    ...
    analysis_items: typing.Optional[AgentAnalysisItemsInput] = pydantic.Field(default=None)
    """
    ...
    guardrails: typing.Optional[GuardrailsV1Input] = pydantic.Field(default=None)
    """
    ...
    alerting: typing.Optional[AlertingSettings] = pydantic.Field(default=None)
    """
