...
# update_forward_refs(PromptAgentApiModelInputToolsItem_Client)  # Moved to _update_forward_refs_once()
# update_forward_refs(PromptAgentApiModelInputToolsItem_Webhook)  # Moved to _update_forward_refs_once()
