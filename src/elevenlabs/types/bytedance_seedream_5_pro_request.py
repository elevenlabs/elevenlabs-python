...
class BytedanceSeedream5ProRequest(UncheckedBaseModel):
    ...
    aspect_ratio: typing.Optional[BytedanceSeedream5ProRequestAspectRatio] = pydantic.Field(default=None)
    """
    ...
    resolution: typing.Optional[BytedanceSeedream5ProRequestResolution] = pydantic.Field(default=None)
    """
