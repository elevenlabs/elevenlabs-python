...
class AstConditionalOperatorNodeOutputCondition_AddOperator(UncheckedBaseModel):
    """
...
class AstConditionalOperatorNodeOutputCondition_AndOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_BooleanLiteral(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_ConditionalOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_DivOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_DynamicVariable(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_EqOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_GtOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_GteOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_Llm(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_LtOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_LteOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_MulOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_NeqOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_NumberLiteral(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_OrOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_StringLiteral(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
class AstConditionalOperatorNodeOutputCondition_SubOperator(UncheckedBaseModel):
    """
    Condition deciding which expression should be selected.
    """
...
AstConditionalOperatorNodeOutputCondition = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(AstConditionalOperatorNodeOutputCondition_AddOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_AndOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_ConditionalOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_DivOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_EqOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_GtOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_GteOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_LtOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_LteOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_MulOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_NeqOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_OrOperator)
update_forward_refs(AstConditionalOperatorNodeOutputCondition_SubOperator)
