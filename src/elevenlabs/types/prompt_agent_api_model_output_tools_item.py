...
# update_forward_refs(PromptAgentApiModelOutputToolsItem_Client)  # Moved to _update_forward_refs_once()
# update_forward_refs(PromptAgentApiModelOutputToolsItem_Webhook)  # Moved to _update_forward_refs_once()
