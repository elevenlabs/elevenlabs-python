...
class GetPhoneNumbersPageResponseModelPhoneNumbersItem_Exotel(UncheckedBaseModel):
...
class GetPhoneNumbersPageResponseModelPhoneNumbersItem_SipTrunk(UncheckedBaseModel):
...
class GetPhoneNumbersPageResponseModelPhoneNumbersItem_Twilio(UncheckedBaseModel):
...
GetPhoneNumbersPageResponseModelPhoneNumbersItem = typing_extensions.Annotated[
    typing.Union[
