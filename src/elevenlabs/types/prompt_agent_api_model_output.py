...
class PromptAgentApiModelOutput(UncheckedBaseModel):
    ...
    backup_llm_config: typing.Optional[PromptAgentApiModelOutputBackupLlmConfig] = pydantic.Field(default=None)
    """
...
# update_forward_refs(PromptAgentApiModelOutput)  # Moved to _update_forward_refs_once()
