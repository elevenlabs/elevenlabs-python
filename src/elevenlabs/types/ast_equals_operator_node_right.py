...
class AstEqualsOperatorNodeRight_AndOperator(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_BooleanLiteral(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_DynamicVariable(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_EqOperator(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_GtOperator(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_GteOperator(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_Llm(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_LtOperator(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_LteOperator(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_NeqOperator(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_NumberLiteral(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_OrOperator(UncheckedBaseModel):
...
class AstEqualsOperatorNodeRight_StringLiteral(UncheckedBaseModel):
...
AstEqualsOperatorNodeRight = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(AstEqualsOperatorNodeRight_AndOperator)
update_forward_refs(AstEqualsOperatorNodeRight_EqOperator)
update_forward_refs(AstEqualsOperatorNodeRight_GtOperator)
update_forward_refs(AstEqualsOperatorNodeRight_GteOperator)
update_forward_refs(AstEqualsOperatorNodeRight_LtOperator)
update_forward_refs(AstEqualsOperatorNodeRight_LteOperator)
update_forward_refs(AstEqualsOperatorNodeRight_NeqOperator)
update_forward_refs(AstEqualsOperatorNodeRight_OrOperator)
