...
class AstAndOperatorNodeChildrenItem_AndOperator(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_BooleanLiteral(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_DynamicVariable(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_EqOperator(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_GtOperator(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_GteOperator(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_Llm(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_LtOperator(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_LteOperator(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_NeqOperator(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_NumberLiteral(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_OrOperator(UncheckedBaseModel):
...
class AstAndOperatorNodeChildrenItem_StringLiteral(UncheckedBaseModel):
...
AstAndOperatorNodeChildrenItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(AstAndOperatorNodeChildrenItem_AndOperator)
...
update_forward_refs(AstAndOperatorNodeChildrenItem_GteOperator)
update_forward_refs(AstAndOperatorNodeChildrenItem_LtOperator)
update_forward_refs(AstAndOperatorNodeChildrenItem_LteOperator)
update_forward_refs(AstAndOperatorNodeChildrenItem_NeqOperator)
update_forward_refs(AstAndOperatorNodeChildrenItem_OrOperator)
