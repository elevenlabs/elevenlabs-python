...
class CommittedTranscriptWithTimestampsWordsItem(UncheckedBaseModel):
    """
    ...
    type: CommittedTranscriptWithTimestampsWordsItemType = pydantic.Field()
    """
    ...
    characters: typing.Optional[typing.List[CommittedTranscriptWithTimestampsWordsItemCharactersItem]] = pydantic.Field(
        default=None
    )
    """
