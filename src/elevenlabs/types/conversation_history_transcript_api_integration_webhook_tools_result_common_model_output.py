...
class ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelOutput(UncheckedBaseModel):
    request_id: str
    tool_name: str
    result_value: str
    is_error: bool
    ...
    dynamic_variable_updates: typing.List[DynamicVariableUpdateCommonModel]
