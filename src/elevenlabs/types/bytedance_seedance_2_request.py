...
class BytedanceSeedance2Request(UncheckedBaseModel):
    """
    ...
    aspect_ratio: typing.Optional[BytedanceSeedance2RequestAspectRatio] = pydantic.Field(default=None)
    """
    ...
    resolution: typing.Optional[BytedanceSeedance2RequestResolution] = pydantic.Field(default=None)
    """
