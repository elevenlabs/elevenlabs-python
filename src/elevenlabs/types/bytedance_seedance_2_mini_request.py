...
class BytedanceSeedance2MiniRequest(UncheckedBaseModel):
    """
    ...
    aspect_ratio: typing.Optional[BytedanceSeedance2MiniRequestAspectRatio] = pydantic.Field(default=None)
    """
    ...
    resolution: typing.Optional[BytedanceSeedance2MiniRequestResolution] = pydantic.Field(default=None)
    """
