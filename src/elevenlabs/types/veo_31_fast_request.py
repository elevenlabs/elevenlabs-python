...
class Veo31FastRequest(UncheckedBaseModel):
    """
    ...
    aspect_ratio: typing.Optional[Veo31FastRequestAspectRatio] = pydantic.Field(default=None)
    """
    The aspect ratio of the output video.
    """

    resolution: typing.Optional[Veo31FastRequestResolution] = pydantic.Field(default=None)
    """
