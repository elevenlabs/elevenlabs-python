...
class AstOrOperatorNodeChildrenItem_AndOperator(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_BooleanLiteral(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_DynamicVariable(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_EqOperator(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_GtOperator(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_GteOperator(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_Llm(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_LtOperator(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_LteOperator(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_NeqOperator(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_NumberLiteral(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_OrOperator(UncheckedBaseModel):
...
class AstOrOperatorNodeChildrenItem_StringLiteral(UncheckedBaseModel):
...
AstOrOperatorNodeChildrenItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(AstOrOperatorNodeChildrenItem_AndOperator)
update_forward_refs(AstOrOperatorNodeChildrenItem_EqOperator)
update_forward_refs(AstOrOperatorNodeChildrenItem_GtOperator)
update_forward_refs(AstOrOperatorNodeChildrenItem_GteOperator)
update_forward_refs(AstOrOperatorNodeChildrenItem_LtOperator)
update_forward_refs(AstOrOperatorNodeChildrenItem_LteOperator)
update_forward_refs(AstOrOperatorNodeChildrenItem_NeqOperator)
update_forward_refs(AstOrOperatorNodeChildrenItem_OrOperator)
