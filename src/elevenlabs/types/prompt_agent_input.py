...
import pydantic
from .llm import Llm
from .prompt_agent_input_tools_item import PromptAgentInputToolsItem
...
class PromptAgentInput(UncheckedBaseModel):
    ...
    tools: typing.Optional[typing.List[PromptAgentInputToolsItem]] = pydantic.Field(default=None)
    """
