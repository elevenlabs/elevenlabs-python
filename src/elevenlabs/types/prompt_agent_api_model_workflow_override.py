...
from .prompt_agent_api_model_workflow_override_tools_item import PromptAgentApiModelWorkflowOverrideToolsItem
from .rag_config_workflow_override import RagConfigWorkflowOverride


class PromptAgentApiModelWorkflowOverride(UncheckedBaseModel):
    ...
    built_in_tools: typing.Optional[BuiltInToolsWorkflowOverride] = pydantic.Field(default=None)
    """
    ...
    tools: typing.Optional[typing.List[PromptAgentApiModelWorkflowOverrideToolsItem]] = pydantic.Field(default=None)
    """
...
update_forward_refs(PromptAgentApiModelWorkflowOverride)
