...
from .ast_operators_output_consolidated import AstOrOperatorNodeOutputChildrenItem

# update_forward_refs(AstOrOperatorNodeOutput)  # Moved to _update_forward_refs_once()
