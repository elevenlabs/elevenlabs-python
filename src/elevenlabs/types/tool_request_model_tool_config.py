...
# update_forward_refs(ToolRequestModelToolConfig_Client)  # Moved to _update_forward_refs_once()
# update_forward_refs(ToolRequestModelToolConfig_Webhook)  # Moved to _update_forward_refs_once()
