...
class PromptAgentApiModelWorkflowOverrideInput(UncheckedBaseModel):
    ...
    built_in_tools: typing.Optional[BuiltInToolsWorkflowOverrideInput] = pydantic.Field(default=None)
    """
    ...
    backup_llm_config: typing.Optional[PromptAgentApiModelWorkflowOverrideInputBackupLlmConfig] = pydantic.Field(
        default=None
    )
    """
    ...
    tools: typing.Optional[typing.List[PromptAgentApiModelWorkflowOverrideInputToolsItem]] = pydantic.Field(
        default=None
    )
    """
...
# update_forward_refs(PromptAgentApiModelWorkflowOverrideInput)  # Moved to _update_forward_refs_once()
...
def _update_forward_refs_once():
    ...
    if not _forward_refs_updated:
        ...
        update_forward_refs(PromptAgentApiModelWorkflowOverrideInput)
