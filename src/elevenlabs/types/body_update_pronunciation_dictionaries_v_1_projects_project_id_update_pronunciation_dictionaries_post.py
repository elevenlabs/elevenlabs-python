...
class BodyUpdatePronunciationDictionariesV1ProjectsProjectIdUpdatePronunciationDictionariesPost(UncheckedBaseModel):
    pronunciation_dictionary_locators: typing.List[PronunciationDictionaryVersionLocatorDbModel] = pydantic.Field()
    """
