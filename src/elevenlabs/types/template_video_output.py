...
class TemplateVideoOutput(UncheckedBaseModel):
    """
    ...
    failure_reason: typing.Optional[TemplateVideoOutputFailureReason] = pydantic.Field(default=None)
    """
    ...
    content_mime_type: typing.Optional[str] = pydantic.Field(default=None)
    """
