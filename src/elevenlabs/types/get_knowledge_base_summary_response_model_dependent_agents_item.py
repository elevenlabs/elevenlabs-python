...
class GetKnowledgeBaseSummaryResponseModelDependentAgentsItem_Available(UncheckedBaseModel):
...
class GetKnowledgeBaseSummaryResponseModelDependentAgentsItem_Unknown(UncheckedBaseModel):
...
GetKnowledgeBaseSummaryResponseModelDependentAgentsItem = typing_extensions.Annotated[
    typing.Union[
