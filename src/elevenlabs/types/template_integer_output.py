...
class TemplateIntegerOutput(UncheckedBaseModel):
    """
    ...
    failure_reason: typing.Optional[TemplateIntegerOutputFailureReason] = pydantic.Field(default=None)
    """
    ...
    content: typing.Optional[int] = pydantic.Field(default=None)
    """
