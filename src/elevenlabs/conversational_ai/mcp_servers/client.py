...
class McpServersClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        ...
        self.tool_approvals = ToolApprovalsClient(client_wrapper=self._client_wrapper)
...
class AsyncMcpServersClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        ...
        self.tool_approvals = AsyncToolApprovalsClient(client_wrapper=self._client_wrapper)
