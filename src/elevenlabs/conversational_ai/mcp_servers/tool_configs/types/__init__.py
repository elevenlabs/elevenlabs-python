...
if typing.TYPE_CHECKING:
    ...
    from .mcp_tool_config_override_create_request_model_tool_call_sound import (
    ...
    from .mcp_tool_config_override_update_request_model_tool_call_sound import (
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "McpToolConfigOverrideCreateRequestModelToolCallSound": ".mcp_tool_config_override_create_request_model_tool_call_sound",
    ...
    "McpToolConfigOverrideUpdateRequestModelToolCallSound": ".mcp_tool_config_override_update_request_model_tool_call_sound",
}
