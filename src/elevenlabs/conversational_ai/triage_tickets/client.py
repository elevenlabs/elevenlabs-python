...
class AsyncTriageTicketsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.conversational_ai.triage_tickets.list(
                agent_id="agent_id",
                page_size=1,
                conversation_id="conversation_id",
                status="open",
    ...
    async def create_manual(
        ...
        async def main() -> None:
            await client.conversational_ai.triage_tickets.create_manual(
                agent_id="agent_id",
                qa_comment="qa_comment",
            )
    ...
    async def list_assignable_users(
        ...
        async def main() -> None:
            await client.conversational_ai.triage_tickets.list_assignable_users(
                agent_id="agent_id",
            )
    ...
    async def get(
        ...
        async def main() -> None:
            await client.conversational_ai.triage_tickets.get(
                agentqa_ticket_id="agentqa_ticket_id",
            )
    ...
    async def delete(self, agentqa_ticket_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.conversational_ai.triage_tickets.delete(
                agentqa_ticket_id="agentqa_ticket_id",
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.conversational_ai.triage_tickets.update(
                agentqa_ticket_id="agentqa_ticket_id",
            )
    ...
    async def add_comment(
        ...
        async def main() -> None:
            await client.conversational_ai.triage_tickets.add_comment(
                agentqa_ticket_id="agentqa_ticket_id",
                comment="comment",
            )
    ...
    async def add_turn_comment(
        ...
        *,
        ...
        async def main() -> None:
            await client.conversational_ai.triage_tickets.add_turn_comment(
                agentqa_ticket_id="agentqa_ticket_id",
                turn_index=1,
                comment="comment",
            )
