...
class RawExotelClient:
    ...
    ) -> HttpResponse[ExotelOutboundCallResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=ExotelOutboundCallResponse,  # type: ignore
...
class AsyncRawExotelClient:
    ...
    async def outbound_call(
        ...
        *,
        ...
        telephony_call_config: typing.Optional[TelephonyCallConfig] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ExotelOutboundCallResponse]:
        """
        Handle an outbound call via Exotel Connect API
