...
class RawProceduresClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{jsonable_encoder(agent_id)}/branches/{jsonable_encoder(branch_id)}/procedures",
            method="GET",
            params={
    ...
    def compile(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{jsonable_encoder(agent_id)}/branches/{jsonable_encoder(branch_id)}/procedures/compile",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def get(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/convai/agents/{jsonable_encoder(agent_id)}/branches/{jsonable_encoder(branch_id)}/procedures/{jsonable_encoder(procedure_id)}",
            method="GET",
            params={
