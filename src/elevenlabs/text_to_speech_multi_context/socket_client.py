...
TextToSpeechMultiContextSocketClientResponse = typing.Union[ReceiveMessageMulti]


class AsyncTextToSpeechMultiContextSocketClient(EventEmitterMixin):
            ...
            if isinstance(message, bytes):
                ...
                try:
                    yield construct_type(
                        type_=TextToSpeechMultiContextSocketClientResponse, object_=json.loads(message)
                    )  # type: ignore
                except Exception:
                    _logger.warning(
        ...
        try:
            async for raw_message in self._websocket:
                if isinstance(raw_message, bytes):
                    ...
                    try:
                        parsed = construct_type(type_=TextToSpeechMultiContextSocketClientResponse, object_=json_data)  # type: ignore
                    except Exception:
                        _logger.warning(
                            "Skipping unknown WebSocket message; update your SDK version to support new message types."
                        )
    ...
    async def recv(self) -> TextToSpeechMultiContextSocketClientResponse:
        """
        ...
        try:
            return construct_type(type_=TextToSpeechMultiContextSocketClientResponse, object_=json_data)  # type: ignore
        except Exception:
...
class TextToSpeechMultiContextSocketClient(EventEmitterMixin):
    ...
    def recv(self) -> TextToSpeechMultiContextSocketClientResponse:
        """
        Receive a message from the websocket connection.
        """
