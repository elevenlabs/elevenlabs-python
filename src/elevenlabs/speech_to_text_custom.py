...
from .speech_to_text.client import SpeechToTextClient as AutogeneratedSpeechToTextClient
from .speech_to_text.client import AsyncSpeechToTextClient as AutogeneratedAsyncSpeechToTextClient
from .realtime import ScribeRealtime
