...
class AsyncTextToVoiceClient:
    ...
    async def create_previews(
        ...
        *,
        ...
        async def main() -> None:
            await client.text_to_voice.create_previews(voice_description='A sassy squeaky mouse', )
        asyncio.run(main())
        """
    ...
    async def create_voice_from_preview(
        ...
        *,
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.text_to_voice.create_voice_from_preview(voice_name='Sassy squeaky mouse', voice_description='A sassy squeaky mouse', generated_voice_id='37HceQefKmEi3bGovXjL', )
        asyncio.run(main())
        """
