...
from .types.speech_to_speech_convert_as_stream_request_file_format import SpeechToSpeechConvertAsStreamRequestFileFormat
...
class AsyncSpeechToSpeechClient:
    ...
    async def convert(
        ...
        *,
        ...
        async def main() -> None:
            await client.speech_to_speech.convert(voice_id='JBFqnCBsd6RMkjVDRZzb', output_format="mp3_44100_128", model_id='eleven_multilingual_sts_v2', )
        asyncio.run(main())
        """
    ...
    async def convert_as_stream(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.speech_to_speech.convert_as_stream(voice_id='JBFqnCBsd6RMkjVDRZzb', output_format="mp3_44100_128", model_id='eleven_multilingual_sts_v2', )
        asyncio.run(main())
        """
