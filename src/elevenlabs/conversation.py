...
class AudioInterface(ABC):
    ...
    @abstractmethod
    def start(self, input_callback: typing.Callable[[bytes], None]):
...
class Conversation:
    ...
    callback_agent_response: typing.Optional[typing.Callable[[str], None]]
    callback_user_transcript: typing.Optional[typing.Callable[[str], None]]
    callback_latency_measurement: typing.Optional[typing.Callable[[int], None]]

    _thread: typing.Optional[threading.Thread] = None
    _should_stop: threading.Event = threading.Event()
    _conversation_id: typing.Optional[str] = None
    ...
    def __init__(
        ...
        *,
        requires_auth: bool,
        audio_interface: AudioInterface,
        callback_agent_response: typing.Optional[typing.Callable[[str], None]] = None,
        callback_user_transcript: typing.Optional[typing.Callable[[str], None]] = None,
        callback_latency_measurement: typing.Optional[typing.Callable[[int], None]] = None,
    ):
    ...
    def wait_for_session_end(self) -> typing.Optional[str]:
...
def get_default_audio_interface():
    """Returns a default audio interface implementation.

    Uses the default system input and output sound devices.
    """
    try:
        import pyaudio
    except ImportError:
        raise ImportError("To use the default audio interface, you must install and pyaudio.")

    class DefaultInterface(AudioInterface):
