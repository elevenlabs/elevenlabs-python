...
class ProjectsClient:
    ...
    def add(
        ...
        *,
        ...
        source_type: typing.Optional[ProjectsAddRequestSourceType] = OMIT,
    ...
    def get_snapshots(
        ...
        """
        _response = self._raw_client.get_snapshots(project_id, request_options=request_options)
        return _response.data
    ...
    def get_project_snapshot(
        ...
        """
        _response = self._raw_client.get_project_snapshot(
    ...
    def stream_audio(
        ...
        *,
        ...
        typing.Iterator[bytes]
            Successful Response
        """
        with self._raw_client.stream_audio(
    ...
    def update_pronunciation_dictionaries(
        ...
        *,
        ...
        """
        _response = self._raw_client.update_pronunciation_dictionaries(
            project_id,
            pronunciation_dictionary_locators=pronunciation_dictionary_locators,
...
class AsyncProjectsClient:
    ...
    async def get(
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.studio.projects.get(project_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def update_metadata(
        ...
        *,
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.studio.projects.update_metadata(project_id='21m00Tcm4TlvDq8ikWAM', name='Project 1', default_title_voice_id='21m00Tcm4TlvDq8ikWAM', default_paragraph_voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def delete(
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.studio.projects.delete(project_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def update_content(
        ...
        *,
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.studio.projects.update_content(project_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def convert(
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.studio.projects.convert(project_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def get_snapshots(
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.studio.projects.get_snapshots(project_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
        _response = await self._raw_client.get_snapshots(project_id, request_options=request_options)
        return _response.data
    ...
    async def get_project_snapshot(
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.studio.projects.get_project_snapshot(project_id='21m00Tcm4TlvDq8ikWAM', project_snapshot_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
        _response = await self._raw_client.get_project_snapshot(
            project_id, project_snapshot_id, request_options=request_options
        )
        return _response.data
    ...
    async def stream_audio(
        ...
        *,
        ...
        typing.AsyncIterator[bytes]
            Successful Response
        """
        async with self._raw_client.stream_audio(
            project_id, project_snapshot_id, convert_to_mpeg=convert_to_mpeg, request_options=request_options
        ) as r:
    ...
    async def update_pronunciation_dictionaries(
        ...
        *,
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.studio.projects.update_pronunciation_dictionaries(project_id='21m00Tcm4TlvDq8ikWAM', pronunciation_dictionary_locators=[PronunciationDictionaryVersionLocatorDbModel(pronunciation_dictionary_id='pronunciation_dictionary_id', )], )
        asyncio.run(main())
        """
        _response = await self._raw_client.update_pronunciation_dictionaries(
            project_id,
            pronunciation_dictionary_locators=pronunciation_dictionary_locators,
            invalidate_affected_text=invalidate_affected_text,
            request_options=request_options,
