...
class RawProjectsClient:
    ...
    ) -> HttpResponse[GetProjectsResponseModel]:
        """
    ...
    ) -> HttpResponse[ProjectExtendedResponseModel]:
        """
    ...
    def get_snapshots(
        self, project_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[ProjectSnapshotsResponseModel]:
        """
...
class AsyncRawProjectsClient:
    ...
    async def get_all(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetProjectsResponseModel]:
        """
        Returns a list of your Studio projects with metadata.
    ...
    async def get(
        self, project_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ProjectExtendedResponseModel]:
        """
        Returns information about a specific Studio project. This endpoint returns more detailed information about a project than `GET /v1/studio`.
    ...
    async def get_snapshots(
        self, project_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ProjectSnapshotsResponseModel]:
        """
        Retrieves a list of snapshots for a Studio project.
