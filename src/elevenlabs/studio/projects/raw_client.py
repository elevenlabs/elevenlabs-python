        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                ...
                "genres": json.dumps(jsonable_encoder(genres)) if genres is not OMIT else OMIT,
                ...
                "pronunciation_dictionary_locators": json.dumps(jsonable_encoder(pronunciation_dictionary_locators))
                ...
                "voice_settings": json.dumps(jsonable_encoder(voice_settings)) if voice_settings is not OMIT else OMIT,
