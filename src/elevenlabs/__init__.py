...
if typing.TYPE_CHECKING:
    ...
    from .audio_native import CreateAudioNativeRequestApplyTextNormalization
    ...
    from .history import ListHistoryRequestSortDirection, ListHistoryRequestSource
    from .music import (
    ...
    from .speech_engine import ReceiveUpstreamMessage, SendUpstreamMessage
    ...
    from .voices import EditVoiceRequestLabels, GetSharedVoicesRequestCategory, GetSharedVoicesRequestSort
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AudioChunk": ".types",
    "AudioChunkAlignment": ".types",
    "AudioChunkMulti": ".types",
    "AudioChunkMultiAlignment": ".types",
    "AudioChunkMultiNormalizedAlignment": ".types",
    "AudioChunkNormalizedAlignment": ".types",
    ...
    "AudioOutput": ".types",
    "AudioOutputAlignment": ".types",
    "AudioOutputMulti": ".types",
    "AudioOutputMultiAlignment": ".types",
    "AudioOutputMultiNormalizedAlignment": ".types",
    "AudioOutputNormalizedAlignment": ".types",
    "AudioRefChunk": ".types",
    ...
    "BillingPeriod": ".types",
    "BodyAddALanguageToTheResourceV1DubbingResourceDubbingIdLanguagePost": ".types",
    ...
    "BodyAddToKnowledgeBaseV1ConvaiKnowledgeBasePost": ".types",
    ...
    "BodyCreateANewSpeakerV1DubbingResourceDubbingIdSpeakerPost": ".types",
    ...
    "BodyDubsAllOrSomeSegmentsAndLanguagesV1DubbingResourceDubbingIdDubPost": ".types",
    "BodyMoveSegmentsBetweenSpeakersV1DubbingResourceDubbingIdMigrateSegmentsPost": ".types",
    "BodyRenderAudioOrVideoForTheGivenLanguageV1DubbingResourceDubbingIdRenderLanguagePost": ".types",
    "BodySimulatesAConversationStreamV1ConvaiAgentsAgentIdSimulateConversationStreamPost": ".types",
    "BodySimulatesAConversationV1ConvaiAgentsAgentIdSimulateConversationPost": ".types",
    ...
    "BodyTranscribesSegmentsV1DubbingResourceDubbingIdTranscribePost": ".types",
    "BodyTranslatesAllOrSomeSegmentsAndLanguagesV1DubbingResourceDubbingIdTranslatePost": ".types",
    "BodyUpdateMetadataForASpeakerV1DubbingResourceDubbingIdSpeakerSpeakerIdPatch": ".types",
    ...
    "ColumnUnit": ".types",
    "CommittedTranscript": ".types",
    "CommittedTranscriptEntities": ".types",
    "CommittedTranscriptEntitiesEntitiesItem": ".types",
    "CommittedTranscriptWithTimestamps": ".types",
    "CommittedTranscriptWithTimestampsWordsItem": ".types",
    "CommittedTranscriptWithTimestampsWordsItemCharactersItem": ".types",
    "CommittedTranscriptWithTimestampsWordsItemType": ".types",
    ...
    "ComposeDetailedMusicRequestOutputFormat": ".music",
    "ComposeDetailedStreamMusicRequestOutputFormat": ".music",
    "ComposeMusicRequestOutputFormat": ".music",
    ...
    "ConvertSpeechToSpeechRequestOutputFormat": ".speech_to_speech",
    "ConvertSpeechToTextRequestEntityDetection": ".speech_to_text",
    "ConvertSpeechToTextRequestEntityRedaction": ".speech_to_text",
    "ConvertSpeechToTextRequestFileFormat": ".speech_to_text",
    "ConvertSpeechToTextRequestMultichannelOutputStyle": ".speech_to_text",
    "ConvertSpeechToTextRequestTimestampsGranularity": ".speech_to_text",
    "ConvertSpeechToTextRequestWebhookMetadata": ".speech_to_text",
    "ConvertSpeechToTextResponse": ".speech_to_text",
    "ConvertTextToDialogueRequestOutputFormat": ".text_to_dialogue",
    "ConvertTextToSpeechRequestOutputFormat": ".text_to_speech",
    "ConvertWithTimestampsTextToDialogueRequestOutputFormat": ".text_to_dialogue",
    "ConvertWithTimestampsTextToSpeechRequestOutputFormat": ".text_to_speech",
    "CrawlStatus": ".types",
    "CrawlType": ".types",
    ...
    "CreateAudioNativeRequestApplyTextNormalization": ".audio_native",
    ...
    "CreateEnvironmentVariablesRequestBody": ".environment_variables",
    "CreateEnvironmentVariablesRequestBody_AuthConnection": ".environment_variables",
    "CreateEnvironmentVariablesRequestBody_Secret": ".environment_variables",
    "CreateEnvironmentVariablesRequestBody_String": ".environment_variables",
    ...
    "Final": ".types",
    "FinalAudioForTurn": ".types",
    "FinalAudioForTurnMulti": ".types",
    "FinalMulti": ".types",
    "FinalOutput": ".types",
    ...
    "GetSharedVoicesRequestCategory": ".voices",
    "GetSharedVoicesRequestSort": ".voices",
    ...
    "InitialiseContextGenerationConfig": ".types",
    "InitialiseContextPronunciationDictionaryLocatorsItem": ".types",
    "InitialiseContextVoiceSettings": ".types",
    "InitializeConnection": ".types",
    "InitializeConnectionGenerationConfig": ".types",
    "InitializeConnectionMulti": ".types",
    "InitializeConnectionMultiGenerationConfig": ".types",
    "InitializeConnectionMultiPronunciationDictionaryLocatorsItem": ".types",
    "InitializeConnectionMultiVoiceSettings": ".types",
    "InitializeConnectionPronunciationDictionaryLocatorsItem": ".types",
    "InitializeConnectionVoiceSettings": ".types",
    ...
    "ListDubbingRequestCreationSourcesItem": ".dubbing",
    "ListDubbingRequestDubbingModelsItem": ".dubbing",
    "ListDubbingRequestDubbingStatus": ".dubbing",
    "ListDubbingRequestDubbingStatusesItem": ".dubbing",
    "ListDubbingRequestFilterByCreator": ".dubbing",
    "ListDubbingRequestOrderBy": ".dubbing",
    "ListDubbingRequestOrderDirection": ".dubbing",
    "ListEnvironmentVariablesRequestType": ".environment_variables",
    "ListGroupSessionsParams": ".types",
    "ListHistoryRequestSortDirection": ".history",
    "ListHistoryRequestSource": ".history",
    ...
    "ListPronunciationDictionariesRequestSort": ".pronunciation_dictionaries",
    ...
    "McpApprovalPolicyUpdateRequestModel": ".types",
    ...
    "ReceiveDubbingStreamMessage": ".dubbing",
    ...
    "ReviewStatus": ".types",
    "RunSubagentToolConfigInput": ".types",
    "RunSubagentToolConfigOutput": ".types",
    ...
    "ScribeAuthError": ".types",
    "ScribeChunkSizeExceededError": ".types",
    "ScribeError": ".types",
    "ScribeInputError": ".types",
    "ScribeInsufficientAudioActivityError": ".types",
    "ScribeInvalidRequestError": ".types",
    "ScribeQueueOverflowError": ".types",
    "ScribeQuotaExceededError": ".types",
    "ScribeRateLimitedError": ".types",
    "ScribeResourceExhaustedError": ".types",
    "ScribeSessionTimeLimitExceededError": ".types",
    "ScribeThrottledError": ".types",
    "ScribeTranscriberError": ".types",
    "ScribeUnacceptedTermsError": ".types",
    "ScribeWarning": ".types",
    ...
    "SegmentUpdatePayload": ".types",
    "SegmentUpdateResponse": ".types",
    "SegmentedJsonExportOptions": ".types",
    "SendDubbingStreamMessage": ".dubbing",
    "SendMessage": ".text_to_speech",
    "SendMessageMulti": ".text_to_speech_multi_context",
    "SendText": ".types",
    "SendTextGenerationConfig": ".types",
    "SendTextMulti": ".types",
    "SendTextVoiceSettings": ".types",
    "SendTranslateStreamMessage": ".translate",
    "SendUpstreamMessage": ".speech_engine",
    "SentimentAggregate": ".types",
    "SentimentAnalysisSettings": ".types",
    "SeparateStemsMusicRequestStemVariationId": ".music",
    "SessionStarted": ".types",
    "SessionStartedConfig": ".types",
    "SessionStartedConfigAudioFormat": ".types",
    "SessionStartedConfigTimestampsGranularity": ".types",
    ...
    "StatusId": ".types",
    "StreamMusicRequestOutputFormat": ".music",
    "StreamSpeechToSpeechRequestOutputFormat": ".speech_to_speech",
    "StreamTextToSpeechRequestOutputFormat": ".text_to_speech",
    "StreamWithTimestampsTextToSpeechRequestOutputFormat": ".text_to_speech",
    ...
    "SubAgentInput": ".types",
    "SubAgentOutput": ".types",
    "SubagentRunResultDetails": ".types",
    ...
    "SystemToolConfigInputParams_RunSubagent": ".types",
    ...
    "SystemToolConfigOutputParams_RunSubagent": ".types",
    ...
    "TextToDialogueClientMessage": ".types",
    "TextToDialogueClientMessageInputsItem": ".types",
    "TextToDialogueClientMessagePronunciationDictionaryLocatorsItem": ".types",
    "TextToDialogueClientMessageVoiceSettings": ".types",
    "TextToDialogueMultiClientMessage": ".types",
    "TextToDialogueMultiClientMessageInputsItem": ".types",
    "TextToDialogueMultiClientMessagePronunciationDictionaryLocatorsItem": ".types",
    "TextToDialogueMultiClientMessageVoiceSettings": ".types",
    ...
    "TranslateAudio": ".types",
    "TranslateAudioOutputError": ".types",
    "TranslateAuthError": ".types",
    "TranslateEndOfStream": ".types",
    "TranslateError": ".types",
    "TranslateFinalTranscript": ".types",
    "TranslateInputAudioChunk": ".types",
    "TranslateInputError": ".types",
    "TranslatePartialTranscript": ".types",
    "TranslateQueueOverflowError": ".types",
    "TranslateRateLimitedError": ".types",
    "TranslateSessionStarted": ".types",
    "TranslateStatus": ".types",
    "TranslateTranscriberError": ".types",
    "TranslateTranslation": ".types",
    ...
    "UploadMusicRequestExtractCompositionPlan": ".music",
    ...
    "UserModel": ".types",
    "UserTranscript": ".types",
    "UserTranscriptUserTranscriptItem": ".types",
    "UserTypeId": ".types",
    "UsersSortBy": ".types",
...
__all__ = [
    ...
    "CreateAssetParams",
    "CreateAudioNativeProjectRequest",
    "CreateAudioNativeRequestApplyTextNormalization",
    "CreateAuthConnectionEnvironmentVariableRequest",
    "CreateBasicAuthRequest",
    "CreateBearerAuthRequest",
    "CreateClientAppointmentParams",
    ...
    "GetSecretDependenciesResponseModelDependenciesZeroItem_Available",
    "GetSecretDependenciesResponseModelDependenciesZeroItem_Unknown",
    "GetSharedVoicesRequestCategory",
    "GetSharedVoicesRequestSort",
    "GetSimulationTestResponseModel",
    "GetSipLogMessagesResponse",
    "GetSpeechHistoryResponse",
    "GetTestInvocationsPageResponseModel",
    ...
    "ListEnvironmentVariablesRequestType",
    "ListGroupSessionsParams",
    "ListHistoryRequestSortDirection",
    "ListHistoryRequestSource",
    "ListHolidaysParams",
    "ListLocationsParams",
    "ListMcpToolsResponseModel",
    "ListOrdersResponse",
