...
if typing.TYPE_CHECKING:
    ...
    from .v_1_dubbing_realtime import ReceiveDubbingStreamMessage, SendDubbingStreamMessage
    from .v_1_speech_to_text_realtime import ReceiveTranscription
    ...
    from .v_1_translate_realtime import ReceiveTranslateStreamMessage, SendTranslateStreamMessage
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AttachedSystemEvaluationRefAnalysisItemId": ".types",
