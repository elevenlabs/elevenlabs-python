...
class PronunciationDictionaryClient:
    ...
    def add_rules_to_the_pronunciation_dictionary(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(AddPronunciationDictionaryRulesResponseModel, _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(pydantic.parse_obj_as(HttpValidationError, _response.json()))  # type: ignore
        try:
            _response_json = _response.json()
    ...
    def remove_rules_from_the_pronunciation_dictionary(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(RemovePronunciationDictionaryRulesResponseModel, _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(pydantic.parse_obj_as(HttpValidationError, _response.json()))  # type: ignore
        try:
            _response_json = _response.json()
