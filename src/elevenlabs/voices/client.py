...
class VoicesClient:
    ...
    def get_all(
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/voices", method="GET", params={"show_legacy": show_legacy}, request_options=request_options
        )
        try:
    ...
    def get_default_settings(self, *, request_options: typing.Optional[RequestOptions] = None) -> VoiceSettings:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/voices/settings/default", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
    ...
    def get_settings(self, voice_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> VoiceSettings:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/voices/{jsonable_encoder(voice_id)}/settings", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(VoiceSettings, construct_type(type_=VoiceSettings, object_=_response.json()))  # type: ignore
    ...
    def get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="GET",
            params={"with_settings": with_settings},
    ...
    def add_sharing_voice(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            headers={"xi-app-check-token": str(xi_app_check_token) if xi_app_check_token is not None else None},
            request_options=request_options,
            omit=OMIT,
        )
        try:
    ...
    def get_similar_library_voices(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/similar-voices",
            method="POST",
            data={"similarity_threshold": similarity_threshold, "top_k": top_k},
    ...
    def get_a_profile_page(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"profile/{jsonable_encoder(handle)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
