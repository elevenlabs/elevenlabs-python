...
class VoicesClient:
    ...
    def get_default_settings(
        ...
        """
        _response = self._raw_client.get_default_settings(request_options=request_options)
        return _response.data
    ...
    def get_settings(
        ...
        """
        _response = self._raw_client.get_settings(voice_id, request_options=request_options)
        return _response.data
    ...
    def edit_settings(
        ...
        *,
        ...
        """
        _response = self._raw_client.edit_settings(voice_id, request=request, request_options=request_options)
        return _response.data
    ...
    def add_sharing_voice(
        ...
        *,
        ...
        """
        _response = self._raw_client.add_sharing_voice(
    ...
    def get_similar_library_voices(
        ...
        *,
        ...
        """
        _response = self._raw_client.get_similar_library_voices(
    ...
    def get_a_profile_page(
        ...
        """
        _response = self._raw_client.get_a_profile_page(handle, request_options=request_options)
        return _response.data
...
class AsyncVoicesClient:
    ...
    async def get_default_settings(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_default_settings(request_options=request_options)
        return _response.data
    ...
    async def get_settings(
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.get_settings(voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
        _response = await self._raw_client.get_settings(voice_id, request_options=request_options)
        return _response.data
    ...
    async def get(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.get(voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def delete(
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.delete(voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def edit_settings(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.edit_settings(voice_id='21m00Tcm4TlvDq8ikWAM', request=VoiceSettingsResponseModel(stability=1.0, similarity_boost=1.0, style=0.0, use_speaker_boost=True, speed=1.0, ), )
        asyncio.run(main())
        """
        _response = await self._raw_client.edit_settings(voice_id, request=request, request_options=request_options)
        return _response.data
    ...
    async def add(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.add(name='name', )
        asyncio.run(main())
        """
    ...
    async def edit(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.edit(voice_id='21m00Tcm4TlvDq8ikWAM', name='name', )
        asyncio.run(main())
        """
    ...
    async def add_sharing_voice(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.add_sharing_voice(public_user_id='63e06b7e7cafdc46be4d2e0b3f045940231ae058d508589653d74d1265a574ca', voice_id='21m00Tcm4TlvDq8ikWAM', new_name='John Smith', )
        asyncio.run(main())
        """
        _response = await self._raw_client.add_sharing_voice(
            public_user_id, voice_id, new_name=new_name, request_options=request_options
        )
        return _response.data
    ...
    async def get_shared(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.get_shared(featured=True, reader_app_enabled=True, )
        asyncio.run(main())
        """
    ...
    async def get_similar_library_voices(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_similar_library_voices(
            audio_file=audio_file,
            similarity_threshold=similarity_threshold,
            top_k=top_k,
            request_options=request_options,
    ...
    async def get_a_profile_page(
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.get_a_profile_page(handle='talexgeorge', )
        asyncio.run(main())
        """
        _response = await self._raw_client.get_a_profile_page(handle, request_options=request_options)
        return _response.data
