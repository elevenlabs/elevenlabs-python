...
class RawVoicesClient:
    ...
    ) -> HttpResponse[GetVoicesResponseModel]:
        """
    ...
    ) -> HttpResponse[GetVoicesV2ResponseModel]:
        """
    ...
    ) -> HttpResponse[VoiceSettingsResponseModel]:
        """
    ...
    def get(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[VoiceResponseModel]:
        """
    ...
    def get_shared(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GetLibraryVoicesResponseModel]:
        """
    ...
    ) -> HttpResponse[ProfilePageResponseModel]:
        """
...
class AsyncRawVoicesClient:
    ...
    async def get_all(
        self, *, show_legacy: typing.Optional[bool] = None, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetVoicesResponseModel]:
        """
        Returns a list of all available voices for a user.
    ...
    async def search(
        ...
        *,
        ...
        include_total_count: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetVoicesV2ResponseModel]:
        """
        Gets a list of all available voices for a user with search, filtering and pagination.
    ...
    async def get_default_settings(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[VoiceSettingsResponseModel]:
        """
        Gets the default settings for voices. "similarity_boost" corresponds to"Clarity + Similarity Enhancement" in the web app and "stability" corresponds to "Stability" slider in the web app.
    ...
    async def get(
        ...
        *,
        with_settings: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[VoiceResponseModel]:
        """
        Returns metadata about a specific voice.
    ...
    async def get_shared(
        ...
        *,
        ...
        page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GetLibraryVoicesResponseModel]:
        """
        Retrieves a list of shared voices.
    ...
    async def get_a_profile_page(
        self, handle: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ProfilePageResponseModel]:
        """
        Gets a profile page based on a handle
