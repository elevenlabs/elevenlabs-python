...
class AsyncCaptchaClient:
    ...
    async def get(self, voice_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.voices.pvc.verification.captcha.get(voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def verify(
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.pvc.verification.captcha.verify(voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
