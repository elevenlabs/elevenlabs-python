...
class AsyncSpeakersClient:
    ...
    async def get(
        ...
        async def main() -> None:
            await client.voices.pvc.samples.speakers.get(voice_id='21m00Tcm4TlvDq8ikWAM', sample_id='VW7YKqPnjY4h39yTbx2L', )
        asyncio.run(main())
        """
    ...
    async def separate(
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.pvc.samples.speakers.separate(voice_id='21m00Tcm4TlvDq8ikWAM', sample_id='VW7YKqPnjY4h39yTbx2L', )
        asyncio.run(main())
        """
