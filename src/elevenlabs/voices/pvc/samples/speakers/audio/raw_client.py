...
class RawAudioClient:
    ...
    def get(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/voices/pvc/{encode_path_param(voice_id)}/samples/{encode_path_param(sample_id)}/speakers/{encode_path_param(speaker_id)}/audio",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=SpeakerAudioResponseModel,  # type: ignore
