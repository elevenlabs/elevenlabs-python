...
from ....types.sample_response_model import SampleResponseModel
...
class SamplesClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        ...
        self.waveform = WaveformClient(client_wrapper=client_wrapper)

        self.speakers = SpeakersClient(client_wrapper=client_wrapper)
    ...
    ) -> typing.List[SampleResponseModel]:
        """
...
class AsyncSamplesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        ...
        self.waveform = AsyncWaveformClient(client_wrapper=client_wrapper)

        self.speakers = AsyncSpeakersClient(client_wrapper=client_wrapper)
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.voices.pvc.samples.create(voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.pvc.samples.update(voice_id='21m00Tcm4TlvDq8ikWAM', sample_id='VW7YKqPnjY4h39yTbx2L', )
        asyncio.run(main())
        """
    ...
    async def delete(
        ...
        client = AsyncElevenLabs(xi_api_key="YOUR_XI_API_KEY", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.pvc.samples.delete(voice_id='21m00Tcm4TlvDq8ikWAM', sample_id='VW7YKqPnjY4h39yTbx2L', )
        asyncio.run(main())
        """
