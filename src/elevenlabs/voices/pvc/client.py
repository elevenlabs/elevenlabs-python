...
class AsyncPvcClient:
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.voices.pvc.create(name='John Smith', language='en', )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.pvc.update(voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
    ...
    async def train(
        ...
        *,
        ...
        client = AsyncElevenLabs(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.voices.pvc.train(voice_id='21m00Tcm4TlvDq8ikWAM', )
        asyncio.run(main())
        """
