...
from .types.video_to_music_music_request_model_id import VideoToMusicMusicRequestModelId
...
class RawMusicClient:
    ...
    def video_to_music(
        ...
        *,
        ...
        model_id: typing.Optional[VideoToMusicMusicRequestModelId] = OMIT,
        ...
        model_id : typing.Optional[VideoToMusicMusicRequestModelId]
        ...
        *,
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            json={
                ...
                "composition_plan": convert_and_respect_annotation_metadata(
                    object_=composition_plan,
                    annotation=BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostCompositionPlan,
                    direction="write",
                ),
                "music_length_ms": music_length_ms,
                "model_id": model_id,
