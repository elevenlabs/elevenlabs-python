...
class MusicClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        ...
        self.composition_plan = CompositionPlanClient(client_wrapper=self._client_wrapper)
...
class AsyncMusicClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        ...
        self._client_wrapper = client_wrapper
        self.composition_plan = AsyncCompositionPlanClient(client_wrapper=self._client_wrapper)
